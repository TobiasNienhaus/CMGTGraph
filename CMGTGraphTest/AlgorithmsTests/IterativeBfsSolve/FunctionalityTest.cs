    ...
    public class FunctionalityTest
    {
        ...
        public void InvalidNodeAsArgumentTest()
        {
            Assert.Catch<Graph<Point>.NodeNotFoundException>(() =>
                    _testGraph.IterativeBfsSolve(new Point(-100, -100), new Point(-299, -299)),
                "NodeNotFoundException wasn't thrown, even though both of the provided values couldn't be found");

            Assert.Catch<Graph<Point>.NodeNotFoundException>(() =>
                    _testGraph.IterativeBfsSolve(new Point(-100, -100), new Point(950, 800)),
                "NodeNotFoundException wasn't thrown, even though one of the provided values couldn't be found");

            Assert.Catch<Graph<Point>.NodeNotFoundException>(() =>
                    _testGraph.IterativeBfsSolve(new Point(950, 800), new Point(-100, -100)),
                "NodeNotFoundException wasn't thrown, even though one of the provided values couldn't be found");

            Assert.Catch(() =>
                    _testGraph.IterativeBfsSolve(null, new Point(-100, -100)),
                "No Exception was thrown, even though one of the provided values was null");

            Assert.Catch(() =>
                    _testGraph.IterativeBfsSolve(new Point(950, 800), null),
                "No Exception was thrown, even though one of the provided values was null");
        }
        ...
        {
            var path = _testGraph.IterativeBfsSolve(new Point(0, 1), new Point(3, 4));
        ...
        {
            var path = _testGraph.IterativeBfsSolve(new Point(0, 1), new Point(950, 800));
